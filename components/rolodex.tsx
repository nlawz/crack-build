...
import { Ghost, MedalIcon, IceCream, Flower2 } from "lucide-react";
    ...
    return (
        <div
            ...
            <hr
                ...
                className="absolute left-0 right-0 top-1/4 z-[999999999] -translate-y-1/2 border-t-2 border-neutral-800"
            />
        </div>
    );
};
