...
export function NavBar() {
    ...
    return (
        <header
            ...
            <nav className="border border-border px-4 flex items-center backdrop-filter backdrop-blur-xl bg-[#121212] bg-opacity-70 h-[50px] z-[9999] rounded-lg">
                <ContextMenu>
                    <ContextMenuTrigger>
                        <Link href="/">
                        ...
                        return (
                            <li
                                ...
                                {children && (
                                    <div
                                        className={cn(
                                            "absolute top-[48px] w-[576px] -left-[1px] bg-[#121212] flex h-0 group-hover:h-[250px] overflow-hidden transition-all duration-300 ease-in-out border-l-[1px] border-r-[1px]",
                                            hidden && "hidden"
                                        )}>
