...
import { PrimaryButton, SecondaryButton } from "./button-key";
    ...
    return (
        <div className="w-full h-full">
            <div className="relative pt-14">
                ...
                <div className="absolute top-0 inset-x-0 w-full max-w-xl mx-auto pt-40">
                ...
                <SectionTitle
                    ...
                    title={
                        <>
                            ...
                            <br /> Hire cracked labs
                        </>
                    }>
                    <div className="flex flex-col items-center justify-center gap-6 mt-2 sm:mt-5 sm:flex-row z-[999]">
                        <Link href="https://cal.com/cracked/15min">
                            <SecondaryButton
                                label="Chat with me"
                ...
                <div className="mt-8 sm:mt-10 text-balance">
                    <p className="w-full mx-auto text-sm leading-6 text-center text-white/60 max-w-[500px]">
                        i am made of unicorn blood and add value to everything i
                        do. see for yourself.
                    </p>
                </div>
            </div>
...
export const Highlights: React.FC<{ className: string }> = ({ className }) => {
    return (
        <>
            <svg
                className={className}
                ...
                <defs>
                    ...
                    <linearGradient
                        ...
                        <stop stopColor="#61FFCA" />
                        <stop offset="1" stopColor="#61FFCA" stop-opacity="0" />
                    </linearGradient>
                    <linearGradient
                        ...
                        y2="882.5"
                        gradientUnits="userSpaceOnUse">
                        <stop stopColor="#A277FF" />
                        <stop offset="1" stopColor="#A277FF" stop-opacity="0" />
                    </linearGradient>
                    <linearGradient
