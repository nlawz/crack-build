        ...
        <div className="relative flex justify-center w-full">
            <div className="absolute z-50 top-14">
                <button
                    ...
                    <PrimaryButton shiny label="Show code" IconLeft={Wand2} />
                </button>
            </div>
...
function AnalyticsWebAppView() {
    function Tab({
        ...
        return (
            <div
                className={cn(
                    "flex items-center text-white px-2 py-2 rounded-lg",
                    {
                        "bg-white/10": light,
                    }
                )}>
                ...
                return (
                    <pre
                        ...
                        {tokens.map((line, i) => {
                            ...
                            const paddedLineGutter = String(
                                lineNumber
                            ).padStart(gutterPadLength, " ");
                            return (
                                // biome-ignore lint/suspicious/noArrayIndexKey: I got nothing better right now
                                <div
                                    key={`${line}-${i}`}
                                    {...getLineProps({ line })}>
                                    <span className="select-none line-number">
                                        {paddedLineGutter}
                                    </span>
                                    {line.map((token, key) => (
                                        <span
    ...
    return (
        <div className="flex flex-col text-white absolute left-[20px] sm:left-[40px] xl:left-[40px] bottom-[40px] max-w-[286px]">
            ...
            <p className="mt-4 leading-6 text-white/60">
                Get all the code you need to create product features. Full stack
