        ...
        <div className="w-full overflow-hidden relative border-[.75px] h-[576px] rounded-[32px] usage-bento-bg-gradient border-[#ffffff]/10">
            ...
            <div className="relative ">
                <AnimatedList className="w-full">
                    ...
                    <BillingItem
                        icon={<BillingIcon />}
                        text="Unkey sent invoice to customer"
                        latency="1 s"
                    />
                    <BillingItem
                        icon={<PaymentsIcon />}
                        text="Andreas collected payments"
                        latency="2 s"
                    />
                </AnimatedList>
            </div>
...
const ExchangeIcon = () => (
    <svg
        ...
        fill="none">
        <path
            d="M2.5 4.5H13.5M13.5 4.5L10.5 1.5M13.5 4.5L10.5 7.5"
            stroke="white"
        />
        <path
            d="M13.5 11.5H2.5M2.5 11.5L5.5 8.5M2.5 11.5L5.5 14.5"
            stroke="white"
        />
    </svg>
);
...
const PaymentsIcon = () => (
    <svg
        ...
        <path
            d="M1 10.5C2.38071 10.5 3.5 11.6193 3.5 13H1V10.5Z"
            fill="white"
        />
        <path
            d="M12.5 3H15V5.5C13.6193 5.5 12.5 4.38071 12.5 3Z"
            fill="white"
        />
        <path
            d="M12.5 13C12.5 11.6193 13.6193 10.5 15 10.5V13H12.5Z"
            fill="white"
        />
    </svg>
);
        ...
        <div
            ...
            <p className="flex items-center ml-6 text-sm text-white">
                ...
                <svg
                    ...
                    fill="none">
                    <path
                        d="M5 13L8 15.5L13.5 8.5M11.5 14L13.5 15.5L19.5 8.5"
                        stroke="#3CEEAE"
                    />
                </svg>
            </p>
    ...
    return (
        <div className="flex flex-col text-white absolute left-[20px] sm:left-[40px] xl:left-[40px] bottom-[40px] max-w-[3300px]">
            ...
            <p className="mt-4 text-white/60 leading-6 max-w-[350px]">
                Unkey tracks all user actions in your API, making it
                straightforward to bill users based on their usage.
            </p>
        </div>
    );
}
