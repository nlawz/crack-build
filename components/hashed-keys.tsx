...
const ITERATIONS = 50;
const GENERATED_STRINGS_CHARS = Array.from(
    { length: ITERATIONS },
    getRandomString
).map((str) => str.split(""));
    ...
    useEffect(() => {
        ...
        if (hasReachedThreshold) {
            ...
            const interval = setInterval(() => {
                if (idx === ITERATIONS || !GENERATED_STRINGS_CHARS[idx]) {
        ...
        <div className="w-full relative flex items-center justify-end mb-[100px]">
            ...
            <AnimatePresence>
                <motion.div
                    ...
                    <Key
                        text="sk_TEwCE9AY9BFTq1XJdIO"
                        className={cn("relative left-[-3px]")}
                    />
                </motion.div>
            </AnimatePresence>
