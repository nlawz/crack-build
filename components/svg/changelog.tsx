...
export function ChangelogLight({ className }: { className?: string }) {
    return (
        <svg
            className={cn(
                "absolute -top-96 left-0 right-0 -z-10 overflow-x-hidden ",
                className
            )}
            viewBox="0 0 943 622"
            fill="none"
            ...
            <defs>
                <filter
                    ...
                    <feGaussianBlur
                        stdDeviation="44.5"
                        result="effect1_foregroundBlur_6033_132"
                    />
                </filter>
                <filter
