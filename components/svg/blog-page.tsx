...
export const BlogBackgroundLines = ({ className }: { className?: string }) => (
    <svg
        className={cn(
        ...
        <path
            ...
            stroke="url(#paint0_linear_4046_6105)"
            stroke-width="0.75"
        />
        <path
            d="M319.5 -159.658L1 392"
        ...
        <path
            ...
            stroke="url(#paint2_linear_4046_6105)"
            stroke-width="0.75"
        />
        <path
            d="M518 -159.658L199.5 392"
        ...
        <path
            ...
            stroke="url(#paint4_linear_4046_6105)"
            stroke-width="0.75"
        />
        <path
            d="M716.5 -159.658L398 392"
        ...
        <defs>
            ...
            <radialGradient
                ...
                <stop offset="1.5" stopColor="white" stop-opacity="1" />
                <stop offset="0" stopColor="white" stop-opacity="0" />
            </radialGradient>
            <linearGradient
            ...
            <radialGradient
                ...
                gradientTransform="translate(463.5 27) rotate(-158.499) scale(106.405 106.405)">
                <stop offset=".0" stopColor="white" stop-opacity="0" />
                <stop offset=".5" stopColor="white" stop-opacity="1" />
                <stop offset="0" stopColor="white" stop-opacity="0" />
            </radialGradient>
            <linearGradient
            ...
            <linearGradient
                ...
                y2="391.999"
                gradientUnits="userSpaceOnUse">
                <stop offset=".17" stopColor="white" stop-opacity="0" />
                <stop offset=".3" stopColor="white" stop-opacity="1" />
                <stop offset="0" stopColor="white" stop-opacity="0" />
            </linearGradient>
        </defs>
    </svg>
