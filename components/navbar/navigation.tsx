    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            const scrollPercent = Math.min(
                window.scrollY / 2 / scrollThreshold,
                1
            );
        ...
        <motion.nav
            ...
            <div className="container flex items-center justify-between">
                ...
                <div className="hidden sm:flex gap-2">
                    <Link
                        href="https://app.unkey.com/auth/sign-up"
                    ...
                    <Link href="https://app.unkey.com" className="inline-block">
                        <PrimaryButton
                            shiny
                            label="Sign In"
                            IconRight={ChevronRight}
                    ...
                    <DrawerFooter>
                        ...
                        <DrawerClose asChild>
                            <button
                                type="button"
                                className={cn(
                                    "px-4 duration-500 text-white/75 hover:text-white/80 h-10 border rounded-lg text-center bg-black w-full",
                                    className
                                )}>
                                Close
                            </button>
...
const DesktopLinks: React.FC<{ className: string }> = ({ className }) => (
    <ul
        className={cn(
            "items-center hidden gap-8 lg:flex xl:gap-12",
            className
        )}>
        <li>
            <DesktopNavLink href="/story" label="Story" />
        </li>
        <li>
