...
import { MeteorLines, MeteorLinesAngular } from "@/components/ui/meteor-lines";
import { PreviewWrapper } from "@/components/preview-wrapper";

inspired by clerks website

<PreviewWrapper>
    <MeteorLines className="ml-80" speed={2} number={10} />
    <MeteorLinesAngular speed={2} number={10} />
</PreviewWrapper>
<Scrollycoding>
